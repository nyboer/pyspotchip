...
from creds import twit_consumer_key, twit_consumer_secret, twit_access_token_key, twit_access_token_secret
...
def main():
    ...
    if not message:
        PrintUsageAndExit()
    rc = TweetRc()
    consumer_key = consumer_keyflag or GetConsumerKeyEnv() or rc.GetConsumerKey() or twit_consumer_key
    consumer_secret = consumer_secretflag or GetConsumerSecretEnv() or rc.GetConsumerSecret() or twit_consumer_secret
    access_key = access_keyflag or GetAccessKeyEnv() or rc.GetAccessKey() or twit_access_token_key
    access_secret = access_secretflag or GetAccessSecretEnv() or rc.GetAccessSecret() or twit_access_token_secret
